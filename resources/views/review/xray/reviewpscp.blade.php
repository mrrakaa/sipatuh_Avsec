...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white shadow-md w-fit rounded px-8 pt-6 pb-8 mb-4">
            <h1 class="text-2xl font-bold mb-4">Tinjau Formulir PSCP</h1>
            ...
            <div class="bg-white p-4" style="width: 210mm; min-height: 297mm;">
                <div id="format" class="mx-auto">
                    ...
                    <div class="mb-4 border-b-2 border-x-2 border-black">
                        <div class="flex flex-col">
                            <label class="inline-flex items-center mt-2 mb-2 ml-10">
                                <input type="checkbox" class="form-checkbox" {{ $form->terpenuhi ? 'checked' : '' }}
                                    disabled>
                                <!-- Checkbox Terpenuhi -->
                                <span class="ml-2 font-semibold">Terpenuhi</span>
                            </label>
                            <label class="inline-flex items-center ml-10">
                                <input type="checkbox" class="form-checkbox" {{ $form->tidak_terpenuhi ? 'checked' : '' }}
                                    disabled>
                                        ...
                                        <div class="relative flex border-2 border-black" style="height: 100px;">
                                            ...
                                            <div class="absolute inset-0 flex justify-center items-center"
                                                ...
                                                <input type="checkbox" class="form-checkbox"
                                                    style="width: 20px; height: 20px;" {{ $form->t2a_ab ? 'checked' : '' }}
                                                    disabled>
                                                <!-- Checkbox Test 2a -->
                                            </div>
                                        </div>
                                ...
                                <div class="p-4 text-center">
                                    ...
                                    <div class="relative flex border-2 border-black" style="height: 100px;">
                                        ...
                                        <div class="absolute inset-0 flex justify-center items-center"
                                            style="top: -37px;">
                                            <input type="checkbox" class="form-checkbox"
                                                style="width: 20px; height: 20px;" {{ $form->t2a_sp ? 'checked' : '' }}
                                                disabled>
                                            <!-- Checkbox Test 2a -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start mt-2 mb-2 ml-2">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="flex items-center mb-0">
                                                <input type="radio" {{ $form->result == 'pass' ? 'checked' : '' }}
                                                    disabled>
                                                <label for="resultPass" class="text-sm ml-2">PASS</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input type="radio" {{ $form->result == 'fail' ? 'checked' : '' }}
                                                    disabled>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="grid grid-rows-2 gap-2 items-center">
                                            ...
                                            <div class="text-center self-end">
                                                ...
                                                <label class="text-gray-700 font-normal">1. Airport Security
                                                    Officer</label>
                                            </div>
                                            <div class="text-center self-end">
                                                <h4 class="font-bold">
                                                ...
                                                <label class="text-gray-700 font-normal">2. Airport Security
                                                    Supervisor</label>
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="flex flex-col items-center">
                                                @if ($form->supervisor_signature)
                                                    <img src="{{ $form->supervisor_signature }}"
                                                        alt="Tanda tangan Supervisor" id="supervisorSignatureImage">
                                                @else
                    ...
                    <form action="{{ route('pscp.updateStatus', $form->id) }}" method="POST" class="mt-4">
                        @csrf
                        @method('PATCH')
                        <div class="mb-4">
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    `;
                        ...
                        fetch('{{ route('pscp.saveSupervisorSignature', $form->id) }}', {
                            method: 'POST',
                            headers: {
