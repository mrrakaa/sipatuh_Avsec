                    ...
                    <div class="relative" x-data="{ showDatePicker: false }">
                        ...
                        <div x-show="showDatePicker" @click.away="showDatePicker = false"
                            ...
                            <form action="{{ route('generate.merged.pdf') }}" method="POST" class="space-y-4">
                                @csrf
                                <div>
                                    <label for="pdf_start_date" class="block text-sm font-medium text-gray-700 mb-1">
                                        Tanggal Mulai
                                    </label>
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content">
                ...
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir HHMD Pos HBSCP yang belum diperiksa saat ini.</p>
                </div>
                @endif
            </div>
            ...
            <div id="all-content" class="tab-content hidden">
                ...
                @else
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir HHMD Pos HBSCP saat ini.</p>
                </div>
                @endif
            </div>
