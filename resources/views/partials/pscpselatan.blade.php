    ...
    <div class="bg-white shadow-md rounded-lg">
                ...
                <div class="relative w-full sm:w-auto" x-data="{ isOpen: false }">
                    ...
                    <div id="filterDropdown"
                        ...
                        <div class="p-4">
                            ...
                            <form id="dateFilterForm" class="space-y-4" action="{{ route('filter.pscpselatan.forms') }}"
                                method="POST">
                                @csrf
                                <div>
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content">
                <h2 class="text-xl font-bold text-black">Formulir HHMD PSCP Selatan - Belum Diperiksa</h2>
                <h4 class="text-sm font-light text-black mb-4">Daftar formulir HHMD PSCP Selatan yang belum selesai diperiksa</h4>
                ...
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir HHMD PSCP Selatan yang belum diperiksa saat ini.</p>
                </div>
                @endif
            </div>
            ...
            <div id="all-content" class="tab-content hidden">
                <h2 class="text-xl font-bold text-black">Semua Formulir HHMD PSCP Selatan</h2>
                <h4 class="text-sm font-light text-black mb-4">Daftar lengkap semua formulir HHMD PSCP Selatan</h4>
                ...
                @else
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir HHMD PSCP Selatan saat ini.</p>
                </div>
                @endif
            </div>
