        ...
        <div class="bg-white shadow-md rounded-lg">
                        ...
                        <div class="relative w-full sm:w-auto" x-data="{ isOpen: false }">
                            ...
                            <div id="filterDropdown"
                                ...
                                <div class="p-4">
                                    ...
                                    <form id="dateFilterForm" class="space-y-4" action="{{ route('filter.pscp.forms') }}"
                                        method="POST">
                                        @csrf
                                        <div>
            ...
            <div class="p-6">
                ...
                <div id="pending-content" class="tab-content">
                    <h2 class="text-xl font-bold text-black">Formulir PSCP Cabin Selatan - Belum Diperiksa</h2>
                    <h4 class="text-sm font-light text-black mb-4">Daftar formulir PSCP Cabin Selatan yang belum selesai
                        diperiksa</h4>
                    ...
                    @if ($allPscpForms->where('status', 'pending_supervisor')->count() > 0)
                        <div class="overflow-x-auto">
                            <table class="w-full border-collapse bg-white rounded-lg overflow-hidden">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @foreach ($allPscpForms->where('status', 'pending_supervisor') as $form)
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500">Tidak ada formulir PSCP Cabin Selatan yang belum diperiksa saat ini.
                            </p>
                        </div>
                    @endif
                </div>
                ...
                <div id="all-content" class="tab-content hidden">
                    <h2 class="text-xl font-bold text-black">Semua Formulir PSCP Cabin Selatan</h2>
                    <h4 class="text-sm font-light text-black mb-4">Daftar lengkap semua formulir PSCP Cabin Selatan</h4>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex space-x-2">
                                                    ...
                                                    @if ($form->status == 'approved' && Auth::check() && Auth::user()->role === 'superadmin')
                                                        <a href="{{ route('pdf.pscp', $form->id) }}" target="_blank"
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500">Tidak ada formulir PSCP Cabin Selatan saat ini.</p>
                        </div>
                    @endif
                </div>
