@if (!isset($isPdf))
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('pscpForm').addEventListener('submit', function(event) {
        ...
        const checkboxIds = [
            ...
            't3_24_ab', 't1a_32_ab', 't1a_30_ab', 't1a_24_ab',
            't1b_47mm_r3_ab', 't1b_47mm_r4_ab', 't1b_79mm_r3_ab', 't1b_79mm_r4_ab',
            't1b_111mm_r4_ab', 't4_15mm_hab', 't4_15mm_vab', 't4_20mm_hab', 't4_20mm_vab',
            't5_k010mm_ab',
            // Checkbox SP (Samping)
            't2a_sp', 't2b_sp', 't3_14_sp', 't3_16_sp', 't3_18_sp', 't3_20_sp', 't3_22_sp',
            't3_24_sp', 't1a_32_sp', 't1a_30_sp', 't1a_24_sp',
            't1b_47mm_r3_sp', 't1b_47mm_r4_sp', 't1b_79mm_r3_sp', 't1b_79mm_r4_sp',
            't1b_111mm_r4_sp', 't4_15mm_hsp', 't4_15mm_vsp', 't4_20mm_hsp', 't4_20mm_vsp',
            't5_k010mm_sp'
        ];
