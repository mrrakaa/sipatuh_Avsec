...
<div class="container py-8">
    <div class="bg-white shadow-md rounded max-w-4xl mx-auto px-8 pt-6 pb-8 mb-4">
        ...
        <form id="pscpForm" action="{{ route('submit.pscp.cabin') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <tr class="border-b border-black">
                        ...
                        <td class="w-2/3 p-2">
                            <select id="location" name="location" class="w-full border rounded px-2 py-1">
                                ...
                                <option value="Cabin Utara">Cabin Utara</option>
                                <option value="Cabin Selatan">Cabin Selatan</option>
                            </select>
                        </td>
                    </tr>
                    <tr class="border-b border-black">
